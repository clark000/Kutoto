...
from oauth2.oauthpackage.oauth2_init import SocialSites
from oauth2.oauthpackage.oauth2_error import SocialAPIError
from oauth2.oauthpackage.oauth2_set import SOCIALOAUTH_SITES
